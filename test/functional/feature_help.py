...
"""Verify that starting rubd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rubd with -h for help text")
        ...
        self.log.info("Start rubd with -version for version information")
        ...
        self.log.info("Start rubdd with -fakearg to make sure it does not start")
