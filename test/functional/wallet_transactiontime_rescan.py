...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]    # node used to mine RUB and create transactions
        ...
        # generate some RUB to create transactions and check blockcount
        ...
        # send 10 RUB to user's first watch-only address
        self.log.info('Send 10 RUB to user')
        ...
        # send 5 RUB to our second watch-only address
        self.log.info('Send 5 RUB to user')
        ...
        # send 1 RUB to our third watch-only address
        self.log.info('Send 1 RUB to user')
