...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def rub_wallet_process(self, *args):
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.rub_wallet_process(*args)
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `rub-wallet help` raises an error. Use `rub-wallet -help`.
        ...
        self.assert_raises_tool_error('No method provided. Run `rub-wallet -help` for valid methods.')
