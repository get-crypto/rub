...
"""Script for verifying Rub Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
github.com and rubcore-binaries.thepasta.org and compares them.
...
WORKINGDIR = "/tmp/rub_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1="https://github.com/rubpay/rub/releases/download/v"
HOST2="https://rubcore-binaries.thepasta.org/file/rubcore-binaries/"
VERSIONPREFIX=""
...
def main(args):
    ...
    if not success:
        print("github.com failed to provide signature file, "
              "but rubcore-binaries.thepasta.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("github.com and rubcore-binaries.thepasta.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Rub Core binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Rub Core binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
