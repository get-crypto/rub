# Bootstrappable Rub Core Builds

This directory contains the files necessary to perform bootstrappable Rub
Core builds.
...
To build Rub Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/rub-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/rubpay/guix.sigs).
