...
This document provides guidelines for internationalization of the Rub Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rub_en.ts` remains unchanged.
