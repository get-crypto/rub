# Support for Output Descriptors in Rub Core

Since Rub Core v0.17, there is support for Output Descriptors. This is a
...
existing Rub Core wallets, a convenience function `combo` is
...
All RPCs in Rub Core will include the checksum in their output. Only
