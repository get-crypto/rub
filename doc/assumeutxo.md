...
Assumeutxo is a feature that allows fast bootstrapping of a validating rubd
...
considered active. This is the "traditional" mode of operation for rubd.
...
**Failure consideration:** if rubd unexpectedly halts after `m_stop_use` is set on
...
### Rubd restarts sometime after snapshot validation has completed

When rubd initializes again, what began as the snapshot chainstate is now
