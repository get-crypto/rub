...
This guide describes how to build rubd, command-line utilities, and GUI on NetBSD.

**This guide has not been tested for building Rub Core and may fail. Please report your results; contributions welcome.**
...
It is not necessary to build wallet functionality to run rubd or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/rubpay/rub/blob/master/doc/descriptors.md).
...
Rub Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure Rub Core. Here is an example that
