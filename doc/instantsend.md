...
This mechanism has been integrated into Bitcore-Node-Rub which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rubpay/insight-api-rub#web-socket-api](https://github.com/rubpay/insight-api-rub#web-socket-api)
* API: [https://github.com/rubpay/insight-api-rub#instantsend-transactions](https://github.com/rubpay/insight-api-rub#instantsend-transactions)
