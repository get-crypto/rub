// Copyright (c) 2021-2025 The Rub Core developers
...
// See https://github.com/rubpay/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
static constexpr std::array<LLMQParams, 14> available_llmqs = {
    ...
    /**
     * llmq_test (Rub Core 0.17) aka llmq_test_v17
     * This quorum is only used for testing
     *
     */
    LLMQParams{
