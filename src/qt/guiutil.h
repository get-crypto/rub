...
/** Utility functions used by the Rub Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "rub:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load rub specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a rub specific theme is activated (light/dark).*/
    bool rubThemeActive();
