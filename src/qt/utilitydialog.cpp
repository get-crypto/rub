    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage: rub-qt [command-line options] [URI]\n\n"
                         "Optional URI is a Rub address in BIP21 URI format.\n";
...
All the Rub in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 RUB, 0.01 RUB, 0.1 RUB, 1 RUB and 10 RUB -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.rub.org/en/stable/wallets/rubcore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
