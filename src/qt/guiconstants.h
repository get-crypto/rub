...
/* RubGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* RubGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Rub"
#define QAPP_ORG_DOMAIN "rub.org"
#define QAPP_APP_NAME_DEFAULT "Rub-Qt"
#define QAPP_APP_NAME_TESTNET "Rub-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Rub-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Rub-Qt-regtest"
