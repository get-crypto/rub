...
const std::string CURRENCY_UNIT = "RUB"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    RUB_KB,      //!< Use RUB/kB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::RUB_KB) const;
