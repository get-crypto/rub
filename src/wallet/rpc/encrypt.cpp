...
RPCHelpMan walletpassphrase()
{
    return RPCHelpMan{"walletpassphrase",
        ...
        "This is needed prior to performing transactions related to private keys such as sending Rub\n"
        "\nNote:\n"
...
RPCHelpMan encryptwallet()
{
    ...
    "\nNow set the passphrase to use the wallet, such as for signing or sending Rub\n"
