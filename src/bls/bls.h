...
#ifndef RUB_CRYPTO_BLS_H
#define RUB_CRYPTO_BLS_H
...
// bls-rub uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <rubbls/bls.hpp>
#include <rubbls/privatekey.hpp>
#include <rubbls/elements.hpp>
#include <rubbls/schemes.hpp>
#include <rubbls/threshold.hpp>
#undef DOUBLE
#undef SEED
