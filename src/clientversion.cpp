 ...
 * for both rubd and rub-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Rub Core");
...
std::string CopyrightHolders(const std::string& strPrefix, unsigned int nStartYear, unsigned int nEndYear)
{
    ...
    // Check for untranslated substitution to make sure Rub Core copyright is not removed by accident
    if (copyright_devs.find("Rub Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2014, nEndYear) + "The Rub Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rubpay/rub>";
