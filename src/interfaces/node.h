...
//! Interface for the src/evo part of a rub node (rubd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a rub node (rubd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a rub node (rubd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a rub node (rubd process).
...
//! Top-level interface for a rub node (rubd process).
class Node
{
public:
    virtual ~Node() {}
